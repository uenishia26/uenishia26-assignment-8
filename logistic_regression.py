...
def do_experiments(start, end, step_num):
    ...
    plt.subplot(3, 3, 1)
    plt.plot(shift_distances, beta0_list, 'r-o')
    ...
    plt.subplot(3, 3, 3)
    plt.plot(shift_distances, beta2_list, 'r-o')
    ...
    plt.subplot(3, 3, 4)
    plt.plot(shift_distances, slope_list, 'r-o')
    ...
    plt.subplot(3, 3, 5)
    plt.plot(shift_distances, intercept_list, 'r-o')
    ...
    # Plot logistic loss
    plt.subplot(3, 3, 6)
    plt.plot(shift_distances, loss_list, 'r-o')
    ...
    plt.subplot(3, 3, 7)
    plt.plot(shift_distances, margin_widths, 'r-o')
